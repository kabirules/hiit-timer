...
export class Member {
    id: number;// 14046916,
    name: string;//"Patrizia Di Gregorio",
    bio: string;//""I'm the founder of Expats Living in Rome. Since 2001,I've been involved with Expats living in all of Italy, organizing events and volunteering to help people. I'm Italo-American from upstate New York. If you have any questions contact me.",
    status: string;//""active",
    joined: number;// 1297953305000,
    city: string;//""Albany",
    country: string;//""us",
    localized_country_name: string;//""EE. UU.",
    state: string;//""NY",
    lat: number;// 42.65,
    lon: number;// -73.75,
    photo: Photo;
